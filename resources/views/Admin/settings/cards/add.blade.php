            ...
            <div class="card table-card">
                ...
                <div class="card-block" id="card-block">
                    <div class="form-group form-primary">
                        <input type="number" autocomplete="off" name="quantity" id="quantity" class="form-control" required value="{{Request::old('quantity')}}">
                        <label class="float-label">{{__('Quantity')}}</label>
                    </div>
                    
                    <div class="form-group form-primary">
                        <input type="number" autocomplete="off" name="value" id="value" class="form-control" required value="{{Request::old('value')}}">
